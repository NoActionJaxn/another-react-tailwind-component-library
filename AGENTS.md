...
- `src/components/` — component implementations. Current set: `Accolades`, `Accordion`, `AlertDialog`, `Anchor`, `Avatar`, `Badge`, `Button`, `ButtonGroup`, `Checkbox`, `CheckboxGroup`, `Collapsible`, `Container`, `Dialog`, `FlexContainer`, `Footer`, `Form`, `GridContainer`, `Header`, `Hero`, `Label`, `Navigation`, `Pagination`, `PasswordInput`, `Pricing`, `Progress`, `RadioGroup`, `Recents`, `Secure`, `Select`, `Separator`, `Slider`, `Switch`, `TextInput`, `Textarea`, `Tooltip`, `Typography`.
