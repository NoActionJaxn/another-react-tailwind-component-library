...
If you bring your own theme, remember `theme.css`'s `@custom-variant dark` line isn't imported either - see **Dark Mode** for what to add if you want dark mode support with your own palette.

See **Retheming Components** if you want to change a single component's colors instead of the whole palette.
